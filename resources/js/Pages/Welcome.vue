...
<body>
    <nav class="flex items-center justify-between flex-wrap bg-yellow-600 p-10">
        <div class="flex items-center flex-shrink-0 text-white mr-7">
            <div id="app"><img src="https://cdn.discordapp.com/attachments/1029300025827803156/1047787887896309760/fish_icon.png" alt="logo"></div>
        <link rel="icon" type="image/x-icon" href="https://cdn.discordapp.com/attachments/1029300025827803156/1047787887896309760/fish_icon.png" alt="logo">
        ...
        <div class="absolute top-0 left-0 mt-[60%] p-10 m-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
          ...
          <a href="#">
            <div class="overflow-hidden shadow-lg bg-white transform transition duration-500 hover:scale-105 drop-shadow-2xl">
              <img class="w-full" src="https://cdn.discordapp.com/attachments/1029300025827803156/1047787888210890753/fishpic.jpg" alt="image of a fish">
              <div class="px-6 py-4">
